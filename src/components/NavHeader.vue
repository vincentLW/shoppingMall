<template>
  <header class="header">
    ...
    <div class="md-modal modal-normal md-modal-transition" v-bind:class="{'md-show':loginModelFlag}">
      <div class="md-modal-inner">
        <div class="md-top">
          <div class="md-title">Login</div>
          <button class="md-close" @click="loginModelFlag=false"></button>
        </div>
        <div class="md-content">
          <div class="confirm-tips">
            <div class="error-wrap">
              <span class="error error-show" v-show="errorTip">Username or Password is incorrect</span>
            </div>
            <ul>
              <li class="regi_form_input">
                <i class="icon IconPeople"></i>
                <input type="text" tabindex="1" name="loginname"  class="regi_login_input" v-model="userName" placeholder="Username">
              </li>
              <li class="regi_form_input noMargin">
                <i class="icon IconPwd"></i>
                <input type="password" tabindex="2" name="password" class="regi_login_input" v-model="userPwd" placeholder="password" @keyup.enter="login()">
              </li>
            </ul>
          </div>
